...
import { checkWebGLSupport, clearCanvas } from '@/lib/webgl-utils';
import { createRenderer, renderPoints, renderGrid, renderLine } from '@/lib/webgl-renderers';
import type { Point2D } from '@/lib/webgl-renderers';
...
export function WebGLCanvasComponent({
  points,
  type,
  regressionLine,
  centroids,
  ...
  const [useGPU, setUseGPU] = useState(useWebGL && isWebGLSupported);
